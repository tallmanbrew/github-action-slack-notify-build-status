    ...
    describe('for push events', () => {
      it('links to the action workflow', () => {
        ...
        expect(attachments[0].fields.find(a => a.title === 'Workflow')).toEqual({
          title: 'Workflow',
          value: `<https://github.com/tallmanbrew/github-action-slack-notify-build-status/actions/runs/${runId} | CI>`,
          short: true,
        });
      });
      ...
      it('links to the action repo', () => {
        ...
        expect(attachments[0].fields.find(a => a.title === 'Repo')).toEqual({
          title: 'Repo',
          value: `<https://github.com/tallmanbrew/github-action-slack-notify-build-status | tallmanbrew/github-action-slack-notify-build-status>`,
          short: true,
        });
      });
      ...
      it('links to the branch', () => {
        ...
        expect(attachments[0].fields.find(a => a.title === 'Branch')).toEqual({
          title: 'Branch',
          value: `<https://github.com/tallmanbrew/github-action-slack-notify-build-status/commit/abc123 | my-branch>`,
          short: true,
        });
      });
    });
    ...
    describe('for PR events', () => {
      ...
      it('links to the PR', () => {
        ...
        expect(attachments[0].fields.find(a => a.title === 'Pull Request')).toEqual({
          title: 'Pull Request',
          value: `<https://github.com/tallmanbrew/github-action-slack-notify-build-status/pulls/1 | This is a PR>`,
          short: true,
        });
      });
    });
